...
import FLOCFilterbyType from '../../../SAPAssetManager/Rules/FunctionalLocation/FLOCFilterByType';
import FunctionalLocationCaption from '../../../SAPAssetManager/Rules/FunctionalLocation/FunctionalLocationCaption';
...
export default async function FunctionalLocationQueryOptions(context) {
    ...
    if (searchString) {
        ...
        qob.filter(`${getSearchQuery(context, searchString.toLowerCase(), ['FuncLocDesc', 
            'FuncLocId', 'WorkCenter_Main_Nav/PlantId', 'WorkCenter_Main_Nav/WorkCenterDescr', 'WorkCenter_Main_Nav/WorkCenterName', 'WorkCenter_Main_Nav/ExternalWorkCenterId', 'ZSortField'])}`);
        return qob;
    } else {
