...
export default function FinalizeCompletePageMessage(context) {
    ...
    /* sudh  PCN E778 ATR_E778*/
    var sEndTime = WorkOrderCompletionLibrary.getStepValue(context, 'time');
   // alert(aEndTime);
    var aEndTime = sEndTime.split(":");

    if((Number(aEndTime[0]) === 0 && Number(aEndTime[1]) === 0) || (aEndTime[0] === "" || aEndTime[0] === undefined)) {
        message = 'message_time_is_not_entered';
