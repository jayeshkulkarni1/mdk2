...
import { setEquipmentCaptionWithCount } from '../../../SAPAssetManager/Rules/Equipment/OnEquipmentFilterSuccess';
import ModifyListViewSearchCriteria from '../../../SAPAssetManager/Rules/LCNC/ModifyListViewSearchCriteria';
import EquipmentFilterbyType from '../../../SAPAssetManager/Rules/Equipment/EquipmentFilterByType';
import { combineQueries } from '../../../SAPAssetManager/Rules/Equipment/OnEquipmentFilterSuccess';
...
function getSearchQuery(context, searchString) {
    ...
    if (searchString) {
        let searchByProperties = ['EquipDesc', 'WorkCenter_Main_Nav/PlantId', 'WorkCenter_Main_Nav/WorkCenterDescr', 'EquipId', 'WorkCenter_Main_Nav/WorkCenterName',
            'WorkCenter_Main_Nav/ExternalWorkCenterId', 'TechnicalID', 'ZSortField'];
