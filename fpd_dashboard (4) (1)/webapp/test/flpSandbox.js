		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FPD Dashboard",
									"targetURL": "#fdpdashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fdpdashboard-display": {
								"semanticObject": "fdpdashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fdpdashboard",
									"url": sap.ui.require.toUrl("fdpdashboard")
								}
							}
						}
					}
