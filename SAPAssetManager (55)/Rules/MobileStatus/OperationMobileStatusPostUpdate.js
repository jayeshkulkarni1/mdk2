...
export default function OperationMobileStatusPostUpdate(context) {
    ...
    return context.read('/SAPAssetManager/Services/AssetManager.service', 'UserPreferences', ['PreferenceValue'], `$filter=PreferenceGroup eq 'MOBILE_STATUS' and PreferenceName eq '${context.binding.ObjectKey}'`).then (async preferenceValueResult => {
            ...
            await  context.executeAction({
                ...
                'Properties': {
                    ...
                    'Properties': {
                        ...
                        'PreferenceName': updateResult.ObjectKey,
                        'PreferenceValue': updateResult.MobileStatus,
                    },
                },
            });
        } else {
