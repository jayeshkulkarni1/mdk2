            ...
            switch (binding['@odata.type']) {
                ...
                case '#sap_mobile.MyWorkOrderOperation':
                    if (binding.OperationMobileStatus_Nav && binding.OperationMobileStatus_Nav.MobileStatus) {
                        // Read the status from the user preferences asynchronously
                        return context.read('/SAPAssetManager/Services/AssetManager.service', 'UserPreferences', ['PreferenceValue'], `$filter=PreferenceGroup eq 'MOBILE_STATUS' and PreferenceName eq '${context.binding.ObjectKey}'`).then(preferenceValueResult => {
                            ...
                            // Return the updated MobileStatus
