...
export default class {
    ...
    static isAnyOperationStarted(context) {
        ...
        //return this.getStartedOperationsQueryOptions(context).then(queryOption => {
            ...
            return context.read('/SAPAssetManager/Services/AssetManager.service', 'UserPreferences', [], `$filter=PreferenceGroup eq 'MOBILE_STATUS' and PreferenceValue eq 'STARTED'`).then(startedOperationResult => {
                if (startedOperationResult.length > 0) {
