		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Custom Scheduling Process",
									"targetURL": "#schedulingprocessschedulingprocess-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"schedulingprocessschedulingprocess-display": {
								"semanticObject": "schedulingprocessschedulingprocess",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=schedulingprocess.schedulingprocess",
									"url": sap.ui.require.toUrl("schedulingprocess/schedulingprocess")
								}
							}
						}
					}
